...
const LabelPreview = forwardRef<HTMLDivElement, Props>(({ data }, ref) => {
  ...
  // Info row font sizing
  const baseFontSize = isLargeFormat ? Math.max(height * 0.04, 6) : Math.max(height * 0.12, 2.5);
  ...
  return (
    <div className="flex flex-col items-center gap-3">
      <div className="relative">
        <div
          ref={ref}
          className="print-area relative bg-white overflow-hidden"
          style={{
            width: `${scaledW}px`,
            height: `${scaledH}px`,
